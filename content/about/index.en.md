  ...
  - block: markdown
    ...
    content:
      ...
      text: |-
        ...
        The foundations article was submitted to *Chaos* (AIP). The editor recommended it and reclassified it to *AIP Advances*, where it is under consideration. The canonical architecture is the *Summa Tau Sistemica* (Tomes **I–IV** closed; **V** epidemiology in progress). In philosophy of physics, I continue Polo’s project with *El acto de ser relacional-discreto*. The program synthesis is *Systemic Tau and the Discrete Architecture of Time* (2nd ed., ISBN 979-8-18776-367-2).
